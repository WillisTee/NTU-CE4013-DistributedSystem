...
public class Main {
            ...
            while (keep_alive) {
                ...
                switch (chosen_option) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        String cancelBookingID = utils.getBookingID();
                        f.cancelBooking(cancelBookingID,utils);
                        break;
                    case 6:
                        String extendBookingID = utils.getBookingID();
                        f.extendBooking(extendBookingID, utils);
                        break;
                    default:
                        keep_alive=false;
                        return;
    ...
    public static void printFacilMenu(){
        String[] opts = {"Main Menu:",
                ...
                "\t6. Extend booking (Non Idempotent)"
        };
        //print the menu
        for (String opt : opts) {
